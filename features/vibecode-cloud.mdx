...
### Authentication
User sign-up and login with secure password handling. Supports email/password authentication and social login (Google Sign-In via Better Auth).
...
- **API:** Express.js backend with auto-generated routes for your data models

<Note>
  Want to add Google Sign-In? See the [Google Sign-In setup guide](/google-login/setup) after enabling Vibecode Cloud.
</Note>
