...
1. Open your project in Vibecode and share the QR code with the person you want to share to
2. Ask them to download the **Appsmith - Vibecode Apps** app from the [App Store](https://apps.apple.com/us/app/appsmith-vibecode-apps/id6744415724)
3. Once installed, they can scan the QR code in the Appsmith app to run your Vibecode app
