...
description: "Publish your Vibecode app to the iOS App Store"
---
...
3. Click **Preflight** — this inserts the `/appstore-preflight` command into your chat
4. The AI agent will run through a checklist and flag anything that needs fixing

You can also type `/appstore-preflight` directly in the chat at any time.
...
<CardGroup cols={2}>
  <Card title="Share via App Clips" icon="share" href="/getting-started/sharing-app">
    Share your app instantly without the App Store
  </Card>
  <Card title="Deployment Options" icon="rocket" href="/deploying/overview">
    Compare all deployment paths
  </Card>
</CardGroup>