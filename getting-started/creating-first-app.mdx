...
Start by downloading Vibecode and creating your account. You'll need to sign up with your email or preferred authentication method.
...
- Use the [pinch to build menu](/getting-started/pinch-to-build) to customize your app
