...
description: "Step-by-step guide to deploying your app or website on Vibecode"
---
...
Choose something memorable and relevant to your project. Your URL will look like `yourProject.vibecode.app` or similar. Custom domain integrations are coming soon!
...
Configure your app's domain settings. By default, you get a `.vibecode.app` subdomain, but custom domain support is on the way. _(Custom domains coming soon)_
