...
The fastest way to get support is through Intercom chat in the Vibecode app. Simply click the Settings icon and then scroll down to click "Support" and send us a message. You'll receive notifications by email and in-app when we reply.
...
[Learn more about our plans](/introduction/plans-and-credits)
...
<Card title="Getting Started" icon="rocket" href="/introduction/creating-first-app">
...
<Card title="Deploy to App Store" icon="mobile" href="/introduction/deploy-app-store">
...
2. **Email**: [support@vibecodeapp.com](mailto:support@vibecodeapp.com) with "Bug Report" in the subject line
...
- Email us at [support@vibecodeapp.com](mailto:support@vibecodeapp.com) with "Feature Request" in the subject
