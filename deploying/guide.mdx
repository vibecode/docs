...
<img
  src="/deploying/deployment_1.png"
...
<img
  src="/deploying/set_URL_2.png"
  alt="Setting your deployment URL"
  style={{ maxHeight: "400px", display: "block", margin: "0 auto" }}
  className="rounded-lg"
/>

Choose something memorable and relevant to your project. Your URL will look like `yourProject.vibecode.app` or similar. You can also [connect a custom domain](/deploying/custom-domain) to use your own URL.
...
<img
  src="/deploying/deployment_access_4.png"
...
<img
  src="/deploying/deployment_dashboard_5.png"
...
<img
  src="/deploying/dashboard_tabs_6.png"
  alt="Dashboard tabs"
...
Configure your app's domain settings. By default, you get a `.vibecode.app` subdomain. You can connect your own domain — see [Connect a Custom Domain](/deploying/custom-domain) for the full setup guide.
