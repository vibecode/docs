...
description: "Learn how to integrate Google Sign-In with your Vibecode app using Better Auth"
---
...
* [**Google Account**](https://accounts.google.com) (for [Google Cloud](https://cloud.google.com/))
* [**Vibecode Account**](https://vibecodeapp.com) and a project with the agent and deploy available
* [**Database**](/features/backend-auth) — you must have database enabled before you start

<Warning>Your app must be deployed in Vibecode to get your backend URL. You'll get the backend URL in Step 5 — we do this before creating the OAuth client so you only enter the URL once in Google Cloud.</Warning>
...
![Step 5](/google-login/16.png)
![Step 5](/google-login/17.png)
![Step 5](/google-login/18.png)
![Step 5](/google-login/19.png)
![Step 5](/google-login/20.png)
...
![Step 6](/google-login/14.png)
![Step 6](/google-login/15.png)
...
![Step 7](/google-login/21.png)
![Step 8](/google-login/23.png)
...
You've added the Google Client ID and Client Secret to the backend environment variables. Copy and paste the **entire** prompt below into the Vibecode agent so it has full context and can implement Google Sign-In correctly.
