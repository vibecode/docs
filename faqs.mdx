...
<AccordionGroup>
  ...
  <Accordion title="How do I share my apps?">
    ...
    - **[App Clips](/getting-started/sharing-app)**: Share instantly with anyone via a link — no App Store submission required
...
<AccordionGroup>
  <Accordion title="How do I add payments or paywalls to my app?">
    ...
    **[RevenueCat](/payments/revenuecat-setup)**: For in-app purchases and subscriptions — ask the AI to "integrate RevenueCat for subscriptions" and add your API keys via the ENV tab.

    **[Stripe](/payments/stripe-setup)**: For one-time payments and custom payment flows — prompt the AI to "add Stripe payment integration" and configure via the ENV tab.
  ...
  <Accordion title="How do I publish my app to the App Store?">
    ...
    3. Follow the step-by-step wizard to sign in with your Apple Developer credentials, configure your app, and submit
...
<AccordionGroup>
  ...
  <Accordion title="Can I add login to my app?">
    Yes! With [Vibecode Cloud](/features/vibecode-cloud) (available on Plus plans and above), you can add user authentication to your app. Tell the AI "add login to my app" and it will set up secure email/password authentication.
