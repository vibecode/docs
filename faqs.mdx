...
<AccordionGroup>
  <Accordion title="Can I connect my project to a backend to store data?">
    Yes! Vibecode Cloud provides a built-in backend for your app with database, authentication, and file storage. Just tell the AI "add a database and authentication to my app" and it sets everything up automatically.

    Vibecode Cloud is available on Plus plans and above. See the [Vibecode Cloud guide](/features/vibecode-cloud) for details.

    You can also integrate with external services like Supabase or Firebase if you prefer. Simply prompt the AI to add the integration.
  </Accordion>

  <Accordion title="Can I add login to my app?">
    Yes! With Vibecode Cloud (available on Plus plans and above), you can add user authentication to your app. Tell the AI "add login to my app" and it will set up secure email/password authentication.
...
<AccordionGroup>
  <Accordion title="How do I upgrade my account?">
    ...
    4. Choose your desired plan (Plus, Pro, or Max)
